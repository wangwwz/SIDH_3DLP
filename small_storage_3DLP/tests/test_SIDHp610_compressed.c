...
#define EphemeralKeyGeneration_A_new  EphemeralKeyGeneration_A_SIDHp610_Compressed_new
#define EphemeralKeyGeneration_B_new  EphemeralKeyGeneration_B_SIDHp610_Compressed_new
